...
class allSliderIMages extends StatefulWidget {
  allSliderIMages({Key? key}) : super(key: key);

  @override
  State<allSliderIMages> createState() => allSliderIMagesState();
}

class allSliderIMagesState extends State<allSliderIMages> {
  String? location;
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    return Container(
                      ...
                      margin: const EdgeInsets.only( right: 12.0 , top: 10),
